"""
Django settings for cosmiq project.
...
LOCAL_DB_PWD = os.environ.get('LOCAL_DB_PWD')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['www.cosmiq.io', '127.0.0.1']
...
WSGI_APPLICATION = 'cosmiq.wsgi.application'
